...
namespace Client.Services
{
    ...
    public class UrlService
    {
        ...
        /// The lobby address.
        /// </value>
        public string LobbyAddress => $"https://ticnic.azurewebsites.net/game"; // https://localhost:5001/game https://tictactoefyn.azurewebsites.net/game https://ticserver.azurewebsites.net/game
